...
social:
  ...
  - icon: X
    icon_pack: fab
    link: https://twitter.com/lanceWQXu1
    label: Follow me on X (Twitter)
    display:
      header: true
  - icon: graduation-cap # Alternatively, use `google-scholar` icon from `ai` icon pack
    icon_pack: fas
    link: https://scholar.google.com/citations?user=R8gFo18AAAAJ&hl=en
  - icon: github
    icon_pack: fab
    link: https://github.com/lanceXwq/
  - icon: linkedin
    icon_pack: fab
    link: https://www.linkedin.com/in/weiqing-xu-aa3849114/
